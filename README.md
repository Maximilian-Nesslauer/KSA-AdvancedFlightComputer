...
**Tested against KSA 2026.9.7.5402**
...
![chopsticks](docs/images/chopstick_catch.png)
...
are required, as the 6dof dynamics are not accounted for. For this reason, it provides better results with an agile lander using rcs for pointing, rather than big boosters with high rotational inertia.
...
Older releases  up to and including **v0.3.1** remain available under GPLv3.
